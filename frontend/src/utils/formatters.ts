 ...
 * 
 * @example
 * formatDuration(5000) // "1h 23m"
 * formatDuration(2700) // "45m"
 * formatDuration(7800) // "2h 10m"
 ...
 * 
 * @example
 * formatTime(5025) // "01:23:45"
 * formatTime(1425) // "23:45"
 * formatTime(45) // "00:45"
 */
 ...
 * 
 * @example
 * formatYear("2022-05-06") // "2022"
 * formatYear("2022") // "2022"
 * formatYear("invalid") // ""
 */
export function formatYear(date: string): string {
  ...
  // First try to extract year from string (e.g., "2022" or "2022-05-06")
  const yearMatch = date.match(/^\d{4}/);
  if (yearMatch) {
    return yearMatch[0];
  }

  // Try to parse as a full date if no year pattern found
